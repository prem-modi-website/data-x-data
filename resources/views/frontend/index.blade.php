...
@section('content')
 <!--hero section start-->
                ...
                <section class="pb-0 p-0">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="bg-primary box-shadow py-4 px-4 px-lg-8 py-lg-8 text-center rounded z-index-1" data-bg-img="{{asset('frontend/assets/images/bg/04.png')}}">
